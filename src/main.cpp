...
uint256 hashGenesisBlock("0xa66cac5aa405550647f2c88a1b4c1ec4cac07bd4beba280a5a5b0b0fee0b17a6");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1000000); // LifeCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // LifeCoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // LifeCoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb6470c212a040961b4e10712496cd5add3e2fe5784333c05499b50eaed8515fb");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Life Matters";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04617bfa301b3b34233be081ee949584caccc24a3b7ef5194d966c54eed23dbaf5a3dea9e174a18dd8b2fe965b63f9824cfd87c0f0659cd1ab3923fa8213f037fd") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1667515315;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085799251;

        if (fTestNet)
        {
            block.nTime    = 1667515297;
            block.nNonce   = 386054449;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x3675e5f8f08403db6344e5395b0380e32783d2815f676406b782ecce79abc318"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0xc3, 0xb4, 0xda }; // LifeCoin: increase each by adding 2 to bitcoin's value.
